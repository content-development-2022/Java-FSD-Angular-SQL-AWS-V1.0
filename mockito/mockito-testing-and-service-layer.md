...
Learn to write [**unit tests**](https://howtodoinjava.com/best-practices/unit-testing-best-practices-junit-reference-guide/) **for the service layer** of applications using JUnit 5 and Mockito testing frameworks.

Table Of Contents

1.  [1. Maven Dependencies](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#1-maven-dependencies)
2.  [2. Setup](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#2-setup)
    1.  [2.1. MockitoExtension](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#21-mockitoextension)
    2.  [2.2. MockitoAnnotations.openMocks() method](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#22-mockitoannotationsopenmocks-method)
    3.  [2.3. @Mock vs @InjectMocks](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#23-mock-vs-injectmocks)
3.  [3. JUnit Tests using Mockito](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#3-junit-tests-using-mockito)
    1.  [3.1. Service Layer Tests](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#31-service-layer-tests)
    2.  [3.2. Service Layer Class](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#32-service-layer-class)
    3.  [3.3. Dao Layer Class](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#33-dao-layer-class)
4.  [4. Conclusion](https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockito-junit-example/#4-conclusion)
...
To process Mockito annotations with JUnit 5, we need to use *MockitoExtention* that automatically initializes all the objects annotated with [@Mock and @InjectMocks annotations](https://howtodoinjava.com/mockito/mockito-annotations/).
